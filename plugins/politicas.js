...
Política de privacidad de InsaneService
___________________
Este servicio llamado InsaneService cumple con
las politicas establecidas de whatsapp
y se deben respetar
las seguientes dichas:
...
Este servicio, es libremente 
una decision de cada uno 
...
contenido o información sobre InsaneService, usted nos indemnizará y nos eximirá 
...
ni dirigimos las acciones de los usuarios en InsaneService y no somos responsables
 del contenido o la información que los usuarios transmiten o comparten en InsaneService.
 No somos responsables de ningún contenido o información ofensiva, inapropiada,
 obscena, ilegal u objetable que pueda encontrar en InsaneService. No somos responsables
 de la conducta, ya sea en línea o fuera de línea, de cualquier usuario de InsaneService.

TRATAMOS DE MANTENER InsaneService EN FUNCIONAMIENTO, LIBRE DE ERRORES Y SEGURO, 
PERO USTED LO UTILIZA BAJO SU PROPIO RIESGO. PROPORCIONAMOS InsaneService 
TAL CUAL SIN NINGUNA GARANTÍA EXPRESA O IMPLÍCITA, INCLUYENDO, PERO NO LIMITADO A,
 ...
 Y NO INFRACCIÓN. NO GARANTIZAMOS QUE InsaneService SIEMPRE SERÁ SEGURO, 
SEGURO O LIBRE DE ERRORES O QUE InsaneService SIEMPRE FUNCIONARÁ SIN INTERRUPCIONES,
 RETRASOS O IMPERFECCIONES. InsaneService NO ES RESPONSABLE DE LAS ACCIONES, CONTENIDO,
...
, QUE SURJA DE CUALQUIER FORMA CONECTADA CON CUALQUIER RECLAMO QUE TIENE CONTRA DICHOS TERCEROS.
 ...
 CON ESTA DECLARACIÓN O InsaneService, INCLUSO SI HEMOS SIDO ADVERTIDOS DE LA POSIBILIDAD DE
 ...
 EN TALES CASOS, LA RESPONSABILIDAD DE InsaneService 
SE LIMITARÁ A LA MEDIDA MÁXIMA PERMITIDA POR LA LEY APLICABLE.
　
-. Otro
-.1. Esta Declaración es un acuerdo entre usted y InsaneService, Inc. Las referencias a 
"nosotros", "nosotros" y "nuestro" significan InsaneService, Inc.
-.2. Esta Declaración constituye el acuerdo completo entre las partes con respecto a 
InsaneService y reemplaza cualquier acuerdo anterior.
...
-.10. Cumplirá con todas las leyes aplicables al usar o acceder a InsaneService.
...
y condiciones de uso relacionados a nuestro servicio en
