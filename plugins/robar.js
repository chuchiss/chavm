...
if (ero > 3) return m.reply ('ha sido detenido por la policía') conn.sendFile(m.chat, 'media/detenidou.jpg', 'jpg', null, m, true) global.DATABASE._data.users[m.sender].lastrob = new Date * 1
